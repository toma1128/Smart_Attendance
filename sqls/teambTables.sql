...
CREATE TABLE STUDENT (
    STUDENT_NO  INT PRIMARY KEY,        -- 学籍番号
...
VALUES
    (1204, 12, '松瀬 美咲', 35778),
    (1330, 9, '二村 千沙', 54544),
    (1664, 16, '平沢 真由美', 35188),
    (1793, 5, '福重 良太', 57005),
    (2208, 17, '天満 かおり', 44507),
    (2466, 11, '畑田 健', 34512),
    (2484, 19, '河上 義弘', 19368),
    (2747, 4, 'Khin Thein Zaw', 10261),
    (2984, 18, '中条 るみ', 51450),
    (3395, 6, '増渕 孝弘', 61831),
    (3430, 20, '福本 真理', 79815),
    (3856, 13, '矢田 澄香', 99715),
    (4201, 7, 'Tin Maung Lwin', 38376),
    (4944, 2, '近松 志保', 14681),
    (5007, 15, '大草 琢磨', 72190),
    (5133, 14, '増山 俊', 80796),
    (5476, 1, '新倉 圭吾', 66550),
    ...
    (6804, 20, '川名 雄一', 43546),
    (6806, 19, '石橋 明人', 29032),
    (6868, 13, 'Kim Min-joon', 30187),
    (8154, 9, '川田 唯', 19132),
    (8551, 2, '小寺 和人', 85432),
    (8823, 12, '武石 惟子', 75745),
    (9129, 8, 'Lee Seo-yeon', 61342),
    (9477, 15, '羽石 菜月', 15333)
;
...
VALUES
    (3, 6804, 1, '10:50:00', 2, NULL),
    (3, 2208, 1, '10:46:00', 2, NULL),
    (4, 2466, 1, '09:18:00', 1, '09:20:00'),
    (4, 6806, 1, '09:19:00', 1, '09:17:00'),
    (6, 8823, 2, NULL, 2, NULL),
    (6, 1793, 1, '09:16:00', 1, '09:17:00'),
    (6, 2208, 1, '09:19:00', 1, '09:18:00'),
    (7, 6631, 1, '09:21:00', 1, '09:18:00'),
    (7, 5777, 1, '09:17:00', 2, NULL),
    (17, 3430, 1, '09:15:00', 1, '09:22:00'),
    (18, 3856, 2, NULL, 1, '13:35:00'),
    (18, 4944, 1, '13:31:00', 1, '13:34:00'),
    (19, 5133, 1, '09:21:00', 1, '09:17:00')
;
